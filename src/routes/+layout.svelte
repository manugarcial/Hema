<script lang="ts">
  ...
  const whatsappNumber = '34655107255';
  ...
  onMount(() => {
    ...
    if (!sessionStorage.getItem("cookie-banner-dismissed")) {
      ...
      closeButton?.addEventListener("click", () => {
        ...
        sessionStorage.setItem("cookie-banner-dismissed", "true"); // Remember that the banner has been dismissed
      });
...
<div class="cookie-banner" id="cookie-banner">
  <p>Este sitio web no utiliza cookies para almacenar información. <span id="close-banner" style="cursor:pointer;">Cerrar</span></p>
</div>
